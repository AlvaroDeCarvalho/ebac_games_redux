...
const Produto = ({ game }: Props) => {
  //chamando o dispach para uma variavel
  ...
  return (
    <S.Produto>
      ...
      {/* Para chamar a função adicionar, precisamos criar um evento,
      e o evento so consegue ser passado atras do Dispacher no redux */}
